...
- (void)isCheckedBeaconURL {
    if ([_config.getBeacon_url length] == 0) {
        [_handler handleError:@"The beacon_url is empty"];
    }
    
    if (![self isHTTP:_config.getBeacon_url]) {
